...
> [`0210`](../tasks/backlog/0210-specify-and-support-the-reverse-move-sprint-to-backlog/brief.md)
...
|---|---|---|
| [`0167`](../tasks/backlog/0167-decide-what-the-sprint-driver-does-when-a-spawned-worker-dies/brief.md) | P146 | The driver's §5.4 exit table has **no row for an abnormally-terminated worker**. Has **fired twice**. |
| [`0173`](../tasks/backlog/0173-tighten-the-wiki-completion-flag-block-in-all-three-wiki-skills/brief.md) | P152 | The wiki completion-flag template **manufactures a dead path on every emission** — happening today. **🔄 In progress.** |
| [`0190`](../tasks/backlog/0190-add-adr-037s-worker-side-precedence-clause-to-the-universal-rules-block/brief.md) | P168 | ADR-037 **§4 worker-side** clause was never installed. |
| [`0191`](../tasks/backlog/0191-add-adr-037s-driver-side-clause-to-the-sprint-ship-loops-hard-rules/brief.md) | P169 | ADR-037 **§3 driver-side** clause was never installed. |
| [`0200`](../tasks/backlog/0200-decide-whether-process-review-is-always-the-coder-or-the-architect-gains-the-skill/brief.md) | P178 | The loop routes Process-review to a role the **ADR-018 hook denies**. Has **happened three times**. |
| [`0203`](../tasks/backlog/0203-amend-the-sprint-loops-honor-the-adrs-rule-with-the-faithful-carry-construction/brief.md) | P181 | The verbatim-carry rule **gives no construction for satisfying it**. |
| [`0208`](../tasks/backlog/0208-add-an-exit-table-row-for-a-failed-build-verify-review-spawn-in-the-sprint-loop/brief.md) | P186 | Since `0202`, a failed Build/Verify/Review spawn **orphans an approved-plan artifact**. |
...
> `0167` → `0208` → `0203` → `0191`, then **`0190`, `0200`, `0173` in parallel** (different files).
...
[`0185`](../tasks/backlog/0185-decide-whether-sprint-2-rolls-over-to-a-fresh-board/brief.md) (P163,
