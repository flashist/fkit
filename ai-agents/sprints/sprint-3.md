...
> ## 🟢 ACTIVE — opened 2026-08-06 by OWNER RULING. Rolled over from [Sprint 2](done/sprint-2.md).
>
...
readable at [`sprints/done/sprint-2.md`](done/sprint-2.md).
...
|---|---|---|
| [Sprint 2](done/sprint-2.md) | 1 open (`0222` at `P189`) | **Carried** → `P3` here. Sprint 2's row reads `➡️ Moved to [Sprint 3](../sprint-3.md) — priority P3` and **keeps its historical `P189`** — a moved row's rank on the source board is frozen. |
| [Sprint 2](done/sprint-2.md) | 188 closed (138 done · 5 cancelled · 45 moved) | **Not carried.** They stay on the archived board at the ranks they already hold. **Not one `P<n>` was renumbered.** |
