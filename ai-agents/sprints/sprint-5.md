...
> ## 🟢 ACTIVE — opened 2026-08-10 by OWNER RULING. Follows [Sprint 4](done/sprint-4.md).
>
...
> [`done/sprint-4.md`](done/sprint-4.md)'s banner, and it is what leaves exactly one `sprint-*.md` in
...
are unchanged and stay readable at [`done/sprint-4.md`](done/sprint-4.md).
...
> | 2 | **"New brief for this archival"** | [`0263`](../tasks/backlog/0263-wiki-resync-after-the-sprint-4-archival-and-sprint-5-open/brief.md), Backlog board |
...
2. **Do `0245` and `0246` still get owner-verified?** The 2026-08-08 note recorded the owner
   ...
   **carries `0245`'s and `0246`'s own verification steps** as its acceptance criteria — the fifteen
   ...
   `(agent-closed — not owner-verified)` markers**, which [Sprint 4](done/sprint-4.md)'s banner
...
- **The wiki re-sync of the Sprint 4 archival and this board's opening** — filed 2026-08-10 as
  [`0263`](../tasks/backlog/0263-wiki-resync-after-the-sprint-4-archival-and-sprint-5-open/brief.md)
...
- **No closed row was renumbered by this sprint's opening, on any board.** Sprint 4's eight `P<n>`
  cells are unchanged and frozen at [`done/sprint-4.md`](done/sprint-4.md); the seven Backlog rows
...
- **A wiki re-sync is owed and was NOT performed.** `ai-agents/wiki-vault/` still names **Sprint 3**
  ...
  **Only `fkit-wiki` may write the vault (ADR-005)** — this producer wrote nothing there. The full
  stale-page list is on [`done/sprint-4.md`](done/sprint-4.md)'s banner. ⚠️ Whether the existing
