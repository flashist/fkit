...
[`0392`](../../tasks/done/0392-architecture-md-prose-repair-9-1-inventory-9-1-occurrence-b-and-9-5-residuals/brief.md)
...
> ⚠️ **DATED NOTE 2026-09-15 — THIS RISK DID NOT MATERIALISE; the section above is left
> byte-identical.** Both decisions were ruled by the owner **2026-09-14** via `AskUserQuestion` in the
> `fkit lead` session, at `0392`'s plan gate, verbatim option labels: **`OD1`** *"Count + named groups
> (Rec)"* · **`OD2`** *"Keep, add dated note (Rec)"* — §9.5 **stays**, so no section was deleted.
> Recorded in `0392`'s `plan.md` under its owner-rulings section. ⛔ **"Unsettled", "NO OWNER RULING
> EXISTS" and "`0393` waits on its answer" in the heading and table above are no longer true.** Both
> `0392` and `0393` are closed `✅ Done (agent-closed — not owner-verified)`.
...
> [`0393`](../../tasks/done/0393-the-two-citation-sweeps-architecture-md-outbound-inbound-and-the-repo-wide-adr-nnn-line-class/brief.md).
>
...
> [`0134`](../../tasks/done/0134-decide-the-sanctioned-repair-path-for-a-half-landed-close/brief.md),
...
[`0134`](../../tasks/done/0134-decide-the-sanctioned-repair-path-for-a-half-landed-close/brief.md)'s
...
live on [`0393`](../../tasks/done/0393-the-two-citation-sweeps-architecture-md-outbound-inbound-and-the-repo-wide-adr-nnn-line-class/brief.md).**
...
1. ✅ **ANSWERED 2026-09-14 — OWNER RULING, verbatim option label *"Whole class, case-insensitive
   ...
   **446 / 67** case-insensitively (re-measured 2026-09-14 — see the census section, whose four scopes
   ...
   [`0393`'s brief](../../tasks/done/0393-the-two-citation-sweeps-architecture-md-outbound-inbound-and-the-repo-wide-adr-nnn-line-class/brief.md),
