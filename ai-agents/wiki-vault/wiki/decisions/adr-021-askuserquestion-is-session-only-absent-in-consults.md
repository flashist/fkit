...
- [[tasks/build-the-pretooluse-task-carry-check-hook-and-its-tests]] · [[tasks/record-that-0250-discharged-0188s-d1-and-warn-off-the-reordering]] — *added 2026-08-29:* `0204`, whose first caveat is that ⛔ **approval leaves no artifact, so the hook can never establish condition (b)**; `0324`, written by a spawned producer with no owner channel
- [[tasks/write-the-durable-citation-anchors-convention-page]] — *added 2026-08-29 (lint):* `0171`, whose rulings came through the owner channel this ADR bounds
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/sprint-8-give-sprints-the-lifecycle-tasks-already-have]] — ⭐ **every one of its six rulings was executed by a SPAWNED producer with no owner channel**, relayed by the `fkit-lead` session that held one
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/repair-0194s-false-0190-clause-does-not-exist-premise]] — task `0221`: ⭐ **the no-channel rule honoured exactly** — a widening was surfaced as a choice rather than taken, and the narrower branch was the default until the owner ruled
- *Added 2026-09-16 (sync `b4a1a52`→`a351cb6`):* [[systems/backlog-convergence-and-the-k-measurement]] — ⭐ **the marker measured at 30 of 30**: every brief created in the report's 15-day window carries the spawned-producer no-owner-channel marker, tested for the literal ADR-021 link. ⚠️ **That measurement CORRECTED its own report's framing**, which had claimed 25 of 31 and offered it as a discovery "floor" — ⛔ **it is not a floor at all**, and the real floor is a different rule's 27 of 30
