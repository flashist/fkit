...
- [[tasks/build-the-producer-owned-structure-check-skill]] — task `0245` (2026-08-07): the structure-check skill was made **producer-owned on exactly this ADR's custodianship reasoning** — the producer already owns the task-file lifecycle and board hygiene. ⚠️ **With one carve-out that keeps ADR-005 intact: any repair under `ai-agents/wiki-vault/` routes to `fkit-wiki`, never the producer**
- [[tasks/sprint-4-ship-the-use-ready-self-healing-update]] — the board whose eight closes were all producer-written and all carry the honesty marker this ADR §5 kept
- [[tasks/the-2026-08-13-vault-resync-chain]] — six wiki rows that were **flagged ready, never self-closed**, this rule working as ruled
- [[tasks/the-2026-08-14-retroactive-review-corrections]] — ⚠️ *Added 2026-08-14:* tasks `0291` and `0295`, two more wiki rows the librarian **flagged complete and did not close**; a producer closed both on 2026-08-14, and both carry the `(agent-closed — not owner-verified)` marker §5 kept
- [[tasks/the-2026-08-15-done-in-fact-wiki-closes]] — ⚠️ *Added 2026-08-22:* tasks `0206` and `0238`, two `fkit-wiki`-owned rows a **producer** closed on a triage verdict — ⚠️ **while this vault's own last word on both was `partial — not ready to close`**
- [[tasks/repair-the-three-decay-shapes-across-the-open-backlog-briefs]] — ⚠️ *Added 2026-08-22:* task `0306`, whose seven residuals each name an owed follow-up brief and each say ⛔ **"this step did not file it; filing is producer-only"** — this ADR working as intended, and the reason four owner-ruled follow-ups left the run unfiled
- [[tasks/widen-task-done-to-repair-a-brief-that-contradicts-a-landed-close]] — *added 2026-08-29:* `0229`, a second owner-only exception in the mover's step 1, verified not to widen this ADR's grant
- [[tasks/build-wiki-flag-convention-test]] — *added 2026-08-29:* `0154`, which pins the wiki flag clause this ADR is the reason for — ⭐ **and whose triage misread that clause as contradicting this ADR**
- [[tasks/fix-the-scaffold-producer-row-fkit-task-brief-omission]] · [[tasks/repair-the-moved-folders-own-self-locators-in-task-done]] · [[tasks/record-that-0250-discharged-0188s-d1-and-warn-off-the-reordering]] — *added 2026-08-29:* `0250` (a coder that could not move its own follow-up's folder), `0325` (the self-locator rule inside the mover), and `0324` (⛔ **agent-closed by a spawned producer — the ruling authorized the work, not a verification of it**)
- [[decisions/adr-044-build-role-follows-the-deliverables-skill-vault-rows-skip-at-step-1]] — *added 2026-08-29:* the ADR whose Decision 3 keeps **Close producer-only** unchanged, and whose skip rule rests on this ADR's *"the wiki stays wiki-only"* clause
- [[tasks/write-the-durable-citation-anchors-convention-page]] — *added 2026-08-29 (lint):* `0171`, whose follow-up filings it could not make itself — filing is producer-only
- *Added 2026-09-10 (sync `cf289c2`→`b4a1a52`):* [[tasks/clean-the-in-scope-broken-link-red-set]] — task `0355`, cancelled — the red set measured 0 · [[tasks/sprint-7-stop-manufacturing-record-repair-rows]] — Sprint 7, the board that attacked the record-repair rate (archived 2026-09-08) · [[tasks/sweep-a-the-citation-rot-class-one-verified-pass]] — task `0356`, Sweep A — the citation-rot class in one pass · [[tasks/sweep-b-the-single-site-correction-notes]] — task `0357`, Sweep B — the single-site correction notes
- *Added 2026-09-16 (sync `b4a1a52`→`81f1429`):* [[decisions/adr-048-a-half-landed-close-gets-a-producer-only-reconcile-mode-that-never-upgrades-the-marker]] — ⛔ **the ADR that WIDENS this one's stated limit by name.** Its producer-only reconcile mode inherits Decision 1's rule and needs no new grant, but an out-of-procedure or forged landed value now gets a mover-shaped record; the widening is accepted and carries a mandatory disclosure · [[decisions/adr-047-a-sprint-has-an-explicit-status-and-current-means-every-in-progress-sprint]] — the sprint movers, which inherit this ADR's identity separation and its §5 agent-closed marker
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/build-the-producer-only-sprint-movers]] — task `0341`: ⭐ **this rule applied to SPRINTS**; the mover set grew from two to four, producer-only from the first line
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/decide-the-sanctioned-repair-path-for-a-half-landed-close]] — task `0134` → ADR-048, which **widens this ADR's named limit** by name
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/sprint-8-give-sprints-the-lifecycle-tasks-already-have]] — the board whose four hard rules open with this one
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/record-the-sprint-lifecycle-adr-047]] — task `0337`: ⭐ **SD-3 applied this ADR's reasoning to sprints** — the closing identity separated from the doing identity, role-gating is not prevention, and the marker stays prose
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/give-the-task-movers-a-step-for-the-named-exempt-keys]] — task `0381`: ⚠️ **a spawned producer running a mover cannot edit the coder-owned test file the fix needs** — so the option had to say what the producer does instead
