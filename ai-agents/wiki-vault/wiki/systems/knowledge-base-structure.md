...
- [[tasks/repair-the-moved-folders-own-self-locators-in-task-done]] — *added 2026-08-29:* `0325`, which gave `/fkit-task-done` its self-locator repair rule and the locator-vs-frozen-evidence distinction (*"a historical record's claims are frozen; its links are not"*)
- [[tasks/remediate-the-dead-brief-paths-in-closed-review-ledger-headers]] — *added 2026-08-29:* `0168`, the 67-header backfill of the same class
- [[tasks/record-that-0250-discharged-0188s-d1-and-warn-off-the-reordering]] — *added 2026-08-29:* `0324`, and ⛔ **the accepted gap it names: a brief and a board row have NO header bullet to warn a reader, so a dated correction note below a live instruction can be missed and the instruction executed**
- [[tasks/widen-task-done-to-repair-a-brief-that-contradicts-a-landed-close]] · [[tasks/build-wiki-flag-convention-test]] — *added 2026-08-29:* `0229`, which opened the only sanctioned repair path for a brief whose status contradicts a landed close (⛔ hand-editing stays barred); `0154`, the first test that reads a `SKILL.md` body, pinning the wiki completion-flag convention
