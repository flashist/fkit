...
- [[tasks/sprint-6-repair-the-record-the-board-rests-on]] — ⚠️ *Added 2026-08-22:* 🟢 **the ACTIVE board**, opened 2026-08-14 on a triage of all 108 then-open rows. **7 of 19 rows closed, all agent-closed.** ⚠️ It opened **unranked** — the first board in this project ever to — because the producer that opened it had no owner channel, and was ranked the same day by owner ruling
