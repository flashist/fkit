...
- [[tasks/sprint-3-close-the-rank-integrity-loop]] — the active board since the 2026-08-06 rollover; Sprint 2 is archived at `ai-agents/sprints/done/sprint-2.md`
...
- [[tasks/sprint-5-fix-what-a-real-project-found]] — 🟢 **the ACTIVE board**: the first defect a real downstream project reported in shipped fkit code, plus release hygiene
