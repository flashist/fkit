...
- [[tasks/build-the-closed-rank-immutability-guard]] — task `0182` — `test/closed-rank-immutability.test.js`, the board-history guard (⛔ not continuous protection: no CI runs it)
