...
**Still Backlog (7):** **45 / 51 / 66 / 69 / 71 / 73** — six pre-filed wiki syncs, **all substantively covered** by the 2026-07-19 syncs that recorded this batch; and **64**, the spawned-mover implementation, gated on a mandatory adversarial pass. *(Its parent design, 63, is now **Done** → [[tasks/design-spawned-invocation-consent-model-for-task-movers]] → [[decisions/adr-025-spawned-agents-may-invoke-the-task-movers]].)*
