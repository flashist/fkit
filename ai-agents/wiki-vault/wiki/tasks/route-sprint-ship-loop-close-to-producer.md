...
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/decide-the-sanctioned-repair-path-for-a-half-landed-close]] — task `0134`: ⭐ **this task's review findings `R1`/`R6` are where the half-landed-close gap was first named**, and `0134` is the row that owned it
