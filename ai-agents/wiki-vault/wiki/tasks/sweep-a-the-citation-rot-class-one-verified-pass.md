...
- *Added 2026-09-16 (sync `b4a1a52`→`a351cb6`):* [[systems/backlog-convergence-and-the-k-measurement]] — ⭐ **this sweep is one third of the one-time consolidation that makes the k-report's headline 0.52 unrepresentative.** ⚠️ **The report's own caveat applies to it by name:** any figure whose denominator includes those 29 record-repair closes is measuring a backlog being *consolidated*, not one being *worked*
