...
- *Added 2026-09-16 (sync `b4a1a52`→`a351cb6`):* [[systems/backlog-convergence-and-the-k-measurement]] — ⭐ **the report that settles what this board's 48/21 actually was: a ONE-TIME consolidation event, not a changed rate.** Sweeps A/B/C discharged a standing pool — **27 of this board's 48 closes (56%) were record repairs**, and **28 of the window's 56 closes landed on a single day.** ⛔ **That pool cannot be drained twice.** ⚠️ **It also records this board's criterion as MISSED on the number (18.6% against under 10%) and PASSED by owner ruling on the trend** (*"Treat the trend as the pass"*, 2026-09-13) — ⛔ both halves true, neither cancelling the other
