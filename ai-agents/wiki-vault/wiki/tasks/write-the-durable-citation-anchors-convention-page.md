...
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/the-two-citation-sweeps-architecture-md-and-the-repo-wide-adr-line-class]] — task `0393`: ⭐ **this page's convention is what `D3`/`E3` apply**, and its own sentence — *"a citation form is only as good as the pattern that finds violations of it"* — is what Group E exists to prove. ⚠️ **The `adr-NNN:NNN` coordinates ON this page were triaged `mentioned` and left BYTE-IDENTICAL**
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/sweep-the-repo-only-claude-path-form-out-of-installed-facing-prose]] — task `0390`: ⭐ **ADRs and reports were fenced OUT of that sweep** because their `claude/…:NNN` citations are source-file coordinates in exactly the form this page asks for
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/repair-0194s-false-0190-clause-does-not-exist-premise]] — task `0221`: ⚠️ **the decay this page addresses, recurring on the row filed to fix it**
