...
- [[tasks/rewrite-the-false-no-ci-paragraph-and-fabricated-citation-in-fkit-wiki-lint]] — ⚠️ *Added 2026-08-22:* task `0280` — this task's CI is what made the wiki lint procedure's *"this project has no CI"* paragraph false, **in a file that ships to consuming projects**
- [[tasks/release-mjs-with-branch-other-commits-and-tags-head-but-pushes-a-different-ref]] — *added 2026-08-29:* `0300`, whose guard sits above this gate and whose fixtures bypass it with `--no-test`, disclosed
...
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/architecture-md-prose-repair-9-1-inventory-occurrence-b-and-9-5]] — task `0392`: ⭐ **§9.1's CI record was rewritten to say CI has been EXERCISED** — 43 runs, 39 green, 4 red, measured 2026-09-14 — retiring four falsified clauses this task's landing had made false
- *Added 2026-09-16 (sync `b4a1a52`→`a351cb6`):* [[tasks/correct-the-false-ci-has-never-run-claims-in-architecture-md]] — task `0312`. ⭐ **This row is the shared ROOT CAUSE of `0312`, `0281` and `0376` alike, and it is not carelessness:** landing CI on 2026-08-12 it wrote a *"has not run yet"* caveat that was **true that day**, and nothing revisited it once runs started **the next day**. ⭐ **A defect created by an accurate sentence ageing by one day** — the whole case for the dated-claim convention
