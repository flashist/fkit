...
- *Added 2026-09-16 (sync `b4a1a52`→`c59f4d7`):* [[tasks/decide-the-sanctioned-repair-path-for-a-half-landed-close]] — task `0134` → ADR-048: ⭐ **this task's exception is KEPT UNCHANGED and owner-only**; the wider mode had to rule explicitly on whether it subsumes, keeps or replaces it — *"ruling on it silently is the failure mode"*
