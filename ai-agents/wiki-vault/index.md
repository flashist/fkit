...
- [[tasks/sprint-2-remove-omnigent]] — Remove Omnigent, land Claude-native as the only runtime (**130 done · 52 backlog · 5 cancelled — of 187**, re-derived against `dashboard.sh` 2026-08-03; grew 22 → 187, and long since past its original theme). ⚠️ **It is growing faster than it closes** — the last run shipped 5 and filed ~20; backlog 37 → 52. **24 consecutive agent-closed rows**, none counted by anything. ⚠️ **81% closed is now a structural problem**: 16 of 29 open rows are **unreachable by rank**, and the rollover decision (`0185`) is **deferred by the owner**
