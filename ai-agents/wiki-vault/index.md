...
- [[tasks/sprint-2-remove-omnigent]] — Remove Omnigent, land Claude-native as the only runtime (**125 done · 37 backlog · 5 cancelled — of 167**, re-derived from `dashboard.sh` 2026-08-02; grew 22 → 167, and long since past its original theme). ⚠️ **81% closed is now a structural problem**: 16 of 29 open rows are **unreachable by rank**, and the rollover decision (`0185`) is **deferred by the owner**
