...
cleanup became [task 80](repair-stale-adr-029-stop-hook-links-in-the-vault.md).
...
- **Part D is a one-line absorption from [task 82](refresh-architecture-docs-for-adrs-026-030-and-the-eighth-role.md)**,
...
- **ADR-027 dual-home parity does not apply here — checked, not assumed.** These skills have exactly
  ...
  init.
- **Sequencing against the folder migration.** [Task 76](migrate-tasks-to-folder-structure-and-update-tooling.md)
