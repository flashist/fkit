...
[`0258`](../../done/0258-wiki-resync-of-the-install-and-self-update-page-after-0252/brief.md) resyncs the
...
- **⚠️ ORDERING — recorded as a dated note, deliberately NOT a `Depends on:` edge** (the convention
  ...
  measured 2026-08-13:**
  - **[`0258`](../../done/0258-wiki-resync-of-the-install-and-self-update-page-after-0252/brief.md)** — same
