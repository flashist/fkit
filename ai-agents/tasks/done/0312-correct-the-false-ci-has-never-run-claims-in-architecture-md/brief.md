...
Surfaced during [`0280`](../0280-rewrite-the-false-no-ci-paragraph-and-fabricated-citation-in-fkit-wiki-lint/brief.md)'s
...
[`0283`](../0283-make-the-lockdown-guard-case-test-filesystem-independent/brief.md), which is
...
- **Provenance:** surfaced during
  [`0280`](../0280-rewrite-the-false-no-ci-paragraph-and-fabricated-citation-in-fkit-wiki-lint/brief.md)'s
...
- **⚠️ Root cause is the same landing as `0281`'s:**
  [`0256`](../0256-gate-releases-so-an-untested-tree-cannot-ship/brief.md) landed CI and the
