...
`ai-agents/tasks/done/0204-build-the-pretooluse-task-carry-check-hook-and-its-tests/`), where
...
`ai-agents/tasks/done/0204-build-the-pretooluse-task-carry-check-hook-and-its-tests/brief.md` **exists
