...
[75](../0017-assign-global-task-ids-and-create-registry/brief.md) and
[76](../0062-migrate-tasks-to-folder-structure-and-update-tooling/brief.md) — the entire folder migration.
