...
- ⚠️ **Shares a FILE, but not a ROW, with
  [`0322`](../../backlog/0322-escape-the-stray-pipes-in-the-board-rows-and-guard-against-new-ones/brief.md).** Both
...
- **Related and deliberately NOT pre-decided:**
  ...
  [`0315`](../../backlog/0315-define-the-corrections-header-warning-equivalent-for-briefs-and-board-rows/brief.md).
