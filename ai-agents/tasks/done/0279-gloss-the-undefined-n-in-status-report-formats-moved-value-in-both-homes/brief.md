...
Finding **F3** of task
[`0268`](../0268-gloss-the-moved-to-sprint-n-row-so-n-reads-as-the-sprint-identity-not-a-number/plan.md)'s
...
- **Provenance:** finding **F3** of `0268`'s plan worker
  ([`plan.md`](../0268-gloss-the-moved-to-sprint-n-row-so-n-reads-as-the-sprint-identity-not-a-number/plan.md),
...
- **Independent of [`0278`](../../backlog/0278-confirm-or-disprove-the-filename-derived-moved-href-template-in-task-brief/brief.md)**,
