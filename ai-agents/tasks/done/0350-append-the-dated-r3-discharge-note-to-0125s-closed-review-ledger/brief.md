...
[`0154-build-wiki-flag-convention-test`](../0154-build-wiki-flag-convention-test/brief.md)
...
2. **`0125` IS NOT REOPENED, RE-STATUSED OR MOVED.** It stays `✅ Done (agent-closed — not
   ...
   **appended** dated note is in scope. A closed ledger stays closed —
   ...
   [`0324`](../0324-record-that-0250-discharged-0188s-d1-and-warn-off-the-reordering/brief.md)
...
- ⚠️ **This row is NOT `fkit-coder`-owned, and `/fkit-sprint-ship-loop` does not read `## Owner`** — it
  ...
  [`0270`](../0270-decide-how-the-ship-loop-handles-a-non-coder-owned-task-row/brief.md) →
