...
description: Deeply research the current project architecture and write the findings to ai-agents/knowledge-base/architecture.md, combining evidence-first code investigation with liberal questioning of the user. Makes no commits.
---
...
For a large codebase you may **fan out read-only research sub-agents** (via {{agent_tool}}), one per
