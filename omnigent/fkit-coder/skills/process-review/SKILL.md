...
review that round-trips through a shared reviewer↔coder document, use **process-stateful-review**
instead.
...
(That cross-round memory is exactly what **process-stateful-review** adds.)
