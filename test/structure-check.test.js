...
// 19 Table A dirs + 31 Table B files, as claude/structure-spec.md ships today. Exact on purpose
...
test('scaffold-verbatim project: every row conforming, exit 0, zero mutation', () => {
  ...
  assert.match(r.out, /# summary: conforming=50 missing=0 untouched-stale=0 owner-edited=0 /,
