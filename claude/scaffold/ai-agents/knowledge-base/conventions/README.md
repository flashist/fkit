...
Two conventions ship with the scaffold. They are **yours to amend** — but amend them *here*. A
...
3. **It is enforceable somewhere.** A convention nobody can check is a preference. State where it is
   enforced.
4. **It is not already covered.** Prefer **amending an existing convention** to adding a third or
   fourth document. Two well-known conventions beat six that nobody has read.
