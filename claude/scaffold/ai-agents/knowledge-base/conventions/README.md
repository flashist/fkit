...
Nine conventions ship with the scaffold. They are **yours to amend** — but amend them *here*. A
...
| [`sprint-status-vocabulary.md`](sprint-status-vocabulary.md) | the valid sprint statuses, what "current sprint" means, and the one way to resolve it |
